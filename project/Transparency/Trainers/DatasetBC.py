...
def News20_dataset(args=None):
    dataset = Dataset(name='20News_sports', path='preprocess/20News/vec_20news_sports.p', min_length=6, max_length=500,
                      args=args)
    set_balanced_pos_weight(dataset)
    return dataset
...
def Civil(args=None):
    args = {'output_dir': 'preprocess/Civil'}
    dataset = Dataset(name='civil', path='preprocess/Civil/vec_civil.p', min_length=6,
                      max_length=500, args=args)
    set_balanced_pos_weight(dataset)
    return dataset
